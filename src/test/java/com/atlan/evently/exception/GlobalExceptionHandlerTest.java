...
//         FieldError fieldError = new FieldError("object", "eventName", "Event name is required");
//         MethodArgumentNotValidException ex = new MethodArgumentNotValidException(null, new BindException(fieldError));
//         ServletWebRequest webRequest = new ServletWebRequest(request);
